...
<div id="wrapper">
 ...
 <?php
    ...
    ?>
        ...
        <div style="text-align: center;font-size: 8px;">Located at De Mel Mw, Main Street</div>
        <div style="text-align: center;font-size: 8px;">Kadawatha, Sri Lanka</div>
        <table>
            <tr>
...
<!--         <div style="text-align: center;font-size: 8px; margin-bottom: 10px;"><?php echo $remarks; ?></div> -->  
  ...
  <tr>
            <td  colspan="3" style="border-top: .5px solid;padding-bottom:  2px;padding-top: 2px;"></td>
                        ...
                        <tr> 
                            <td colspan="2" style="padding-top: 5px;padding-bottom: 5px;">Recieved Money: </td>
                        ...
                        <tr>
                          ...
                          <tr>
                           ...
                           <tr style="margin-bottom: 10px;"> 
                            ...
                            <tr>
                                <td colspan="3" style="text-align: center; font-size: 8px; ">www.facebook.com/Espresso Juction</td>
                            </tr>
                        <tr>
